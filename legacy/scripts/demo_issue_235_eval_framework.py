...
cli_commands = [
    "python legacy/evals/run_eval.py --help",
    "python legacy/evals/run_eval.py --config baseline --sample 2",
    "python legacy/evals/run_eval.py --compare --sample 2",
    "python legacy/evals/run_eval.py --custom --k 3 --fusion true --sample 2"
]
...
run_eval_path = project_root / "legacy/evals/run_eval.py"
...
print("  python legacy/evals/run_eval.py --config baseline")
print()
print("  # Compare configurations")
print("  python legacy/evals/run_eval.py --compare")
print()
print("  # Custom configuration")
print("  python legacy/evals/run_eval.py --custom --k 10 --rerank false")
print()
print("  # Save to CSV")
print("  python legacy/evals/run_eval.py --config baseline --output results.csv")
print()
...
python legacy/evals/run_eval.py --config baseline --sample 3

echo -e "\\nTest 3: Configuration comparison (sample)"
python legacy/evals/run_eval.py --compare --sample 2

echo -e "\\nTest 4: Custom configuration"
python legacy/evals/run_eval.py --custom --k 3 --fusion true --rerank false --sample 2
