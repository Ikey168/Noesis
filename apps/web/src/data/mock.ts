...
export const mockOutletRanking: OutletScore[] = [
  { rank: 1, source: "Nature Climate Change",  source_type: "paper",      score_date: "2025-06-23", frame_diversity: 0.74, attribution_rate: 0.88, stance_neutrality: 0.81, composite_score: 0.81, doc_count: 58, claim_count: 42, trend: [0.67, 0.70, 0.72, 0.75, 0.79, 0.81], ci: { lo: 0.76, hi: 0.85, level: 0.95, n: 6 } },
  { rank: 2, source: "Reuters",                source_type: "news",       score_date: "2025-06-23", frame_diversity: 0.71, attribution_rate: 0.82, stance_neutrality: 0.78, composite_score: 0.77, doc_count: 64, claim_count: 78, trend: [0.60, 0.65, 0.70, 0.73, 0.75, 0.77], ci: { lo: 0.69, hi: 0.83, level: 0.95, n: 6 } },
  { rank: 3, source: "Financial Times",        source_type: "news",       score_date: "2025-06-23", frame_diversity: 0.68, attribution_rate: 0.79, stance_neutrality: 0.72, composite_score: 0.73, doc_count: 68, claim_count: 83, trend: [0.55, 0.60, 0.65, 0.68, 0.70, 0.73], ci: { lo: 0.63, hi: 0.80, level: 0.95, n: 6 } },
  { rank: 4, source: "Bloomberg",              source_type: "news",       score_date: "2025-06-23", frame_diversity: 0.55, attribution_rate: 0.84, stance_neutrality: 0.74, composite_score: 0.71, doc_count: 69, claim_count: 91, trend: [0.58, 0.61, 0.64, 0.67, 0.69, 0.71], ci: { lo: 0.64, hi: 0.77, level: 0.95, n: 6 } },
  { rank: 5, source: "STAT News",              source_type: "news",       score_date: "2025-06-23", frame_diversity: 0.62, attribution_rate: 0.75, stance_neutrality: 0.66, composite_score: 0.68, doc_count: 35, claim_count: 31, trend: [0.56, 0.58, 0.60, 0.63, 0.66, 0.68], ci: { lo: 0.55, hi: 0.79, level: 0.95, n: 4 } },
