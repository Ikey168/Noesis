...
STAGE_ALIASES = {
    ...
    "schema-module": "noesis-schema-module-v1",
    "schema-crosswalk": "noesis-schema-crosswalk-v1",
    "schema-migration": "noesis-schema-migration-v1",
    "federated-source": "noesis-knowledge-source-v1",
    "subscription": "noesis-knowledge-subscription-v1",
    "namespace-package": "noesis-knowledge-package-manifest-v1",
    "memory-object": "noesis-memory-object-v1",
    "api-connector": "noesis-declarative-api-source-v1",
    "extractor": "noesis-extractor-definition-v1",
    "canonical-event": "noesis-canonical-event-v1",
    "derived-artifact": "noesis-derived-artifact-v1",
    ...
    "political-source": "noesis-political-source-v1",
    "political-object": "noesis-political-object-v1",
    "political-research": "noesis-political-research-v1",
