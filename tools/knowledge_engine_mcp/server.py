...
def knowledge_engine_capabilities() -> dict:
    ...
    return {
        "contracts": [
            ...
            "noesis-intake-ingest-v1",
            "noesis-intake-refresh-v1",
            "noesis-intake-annotation-v1",
            "noesis-intake-signal-preview-v1",
...
register_intake_research_tools(mcp, _intake_safe, _intake_context)
...
from tools.knowledge_engine_mcp.iteration_intake import (
    register as register_intake_iteration_tools,
)
